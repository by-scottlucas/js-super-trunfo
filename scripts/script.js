...
let cartas = [
    { nome: "Sub-Zero", img: '../../assets/01.png', atributos: { forca: 10, agilidade: 5, magia: 10, combate: 5 } },
    { nome: "Scorpion", img: '../../assets/02.png', atributos: { forca: 1, agilidade: 8, magia: 1, combate: 8 } },
    { nome: "Raiden", img: '../../assets/03.png', atributos: { forca: 9, agilidade: 4, magia: 9, combate: 4 } },
    { nome: "Liu Kang", img: '../../assets/04.png', atributos: { forca: 2, agilidade: 7, magia: 2, combate: 7 } },
    { nome: "Kung Lao", img: '../../assets/05.png', atributos: { forca: 8, agilidade: 3, magia: 8, combate: 3 } },
    { nome: "Mileena", img: '../../assets/06.png', atributos: { forca: 3, agilidade: 8, magia: 3, combate: 8 } },
    { nome: "Kitana", img: '../../assets/07.png', atributos: { forca: 7, agilidade: 2, magia: 7, combate: 2 } },
    { nome: "Frost", img: '../../assets/08.png', atributos: { forca: 4, agilidade: 9, magia: 4, combate: 9 } },
    { nome: "Cassie Cage", img: '../../assets/09.png', atributos: { forca: 6, agilidade: 1, magia: 6, combate: 1 } },
    { nome: "Jacqui Briggs", img: '../../assets/10.png', atributos: { forca: 5, agilidade: 10, magia: 5, combate: 10 } }
];
    ...
    if (card1 !== null && card1.getElementsByTagName('img').length === 0) {
        ...
        switch (cartaSelecionada[0]) {
            case 'subzero':
                ...
                document.getElementById('cartas-select').style.display = '';
                break;
            case 'scorpion':
                carta1 = cartas[1];
        ...
        document.getElementById("cartas").style.width = "90%";
